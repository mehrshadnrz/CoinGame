    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_top_token_request_in_token_update_request",
            ),
            models.UniqueConstraint(
                fields=["gaming_token"],
                condition=models.Q(gaming_token__isnull=False),
                name="unique_gaming_token_request_in_token_update_request",
            ),
            models.CheckConstraint(
                ...
                name="exactly_one_token_set_in_token_update_request",
            ),
        ]
...
class TokenPromotionRequest(models.Model):
    ...
    def __str__(self):
        token = self.top_token or self.gaming_token
        return f"Promotion Request({token}) by {self.user}"
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                check=models.Q(top_token__isnull=False, gaming_token__isnull=True)
                | models.Q(top_token__isnull=True, gaming_token__isnull=False),
                name="exactly_one_token_set_in_promotion_request",
            ),
        ]
